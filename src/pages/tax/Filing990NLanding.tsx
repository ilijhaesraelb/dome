/**
 * 990-N (e-Postcard) Landing Page — Dedicated product page for small nonprofits.
 */
...
import {
  ...
  Heart, Lock, Save, Shield, ShieldCheck, Zap,
} from "lucide-react";
import BackButton from "@/components/BackButton";

const TRUST_CARDS = [
  { icon: DollarSign, title: "Flat-Fee Pricing", desc: "One affordable price, no surprises." },
  { icon: Zap, title: "Simple Questions", desc: "No accounting jargon — just what the IRS needs." },
  { icon: Save, title: "Save & Resume", desc: "Come back anytime. Your progress is auto-saved." },
  { icon: Lock, title: "Secure Uploads", desc: "Bank-grade encryption protects your data." },
  { icon: Heart, title: "Built for Nonprofits", desc: "Designed specifically for small organizations." },
];

const STEPS = [
  { num: "1", title: "Check Eligibility", desc: "Answer a few questions to confirm 990-N is likely right for you." },
  { num: "2", title: "Enter Your Info", desc: "Provide your organization name, EIN, officer details, and tax year." },
  { num: "3", title: "Review & Pay", desc: "Review everything, pay a flat fee, and move to filing support." },
];

const Filing990NLanding = () => (
  <div className="min-h-screen bg-background">
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-16 sm:py-24 text-center text-primary-foreground">
        ...
        <Badge className="bg-secondary/20 text-secondary border-0 mb-4 text-xs">990-N e-Postcard</Badge>
        <h1 className="font-display text-3xl sm:text-5xl font-bold leading-tight">
          Fast, Affordable 990-N Filing<br className="hidden sm:block" /> for Small Nonprofits
        </h1>
        <p className="mt-5 text-base sm:text-lg text-primary-foreground/70 max-w-2xl mx-auto leading-relaxed">
          If your nonprofit likely qualifies for the IRS 990-N e-Postcard, D.O.M.E. will guide you step by step.
        </p>
        <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
          <Link to="/tax/990n/eligibility">
            <Button size="lg" className="gap-2 bg-secondary hover:bg-secondary/90 text-base px-8 py-6 rounded-xl shadow-lg w-full sm:w-auto">
              <CheckCircle2 className="w-5 h-5" /> Check My Eligibility <ArrowRight className="w-4 h-4" />
            </Button>
          </Link>
          <Link to="/tax/990n/workspace">
            <Button size="lg" variant="outline" className="text-base px-8 py-6 rounded-xl w-full sm:w-auto gap-2 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10">
              <FileText className="w-5 h-5" /> I Know I Need 990-N
            </Button>
          </Link>
        </div>
    ...
    <section className="max-w-md mx-auto px-4 py-16 text-center">
      ...
      <h2 className="text-2xl font-display font-bold mb-2">$29</h2>
      <p className="text-sm text-muted-foreground mb-6">
        One price. Guided preparation, review, and filing support workflow included.
      </p>
      <Link to="/tax/990n/eligibility">
...
export default Filing990NLanding;
